...
export default function ItemDetail({product:{id, title, description, price, pictureUrl}, onAdd}) {

  return (
    <div className="row mt-5">
      <div className="col-4 d-flex align-items-start">
        <div>
          <img className="img-fluid" src={`/thumbnail/${pictureUrl}.jpg`} alt={title}/>
        </div>
      </div>
      <div className="col-8">
        <div className="car">
          <div className="card-body px-3 pt-0">
            ...
            <h6><span className="badge bg-danger p-3 py-2 mt-2">20% Dsto</span></h6>
